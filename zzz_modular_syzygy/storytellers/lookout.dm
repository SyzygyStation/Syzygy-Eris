/datum/storyteller/tyrant  //This objective of this storyteller is to spawn antagonists at round-start, and then be quiet to let the crew roleplay and create their own drama.
	config_tag = "lookout"
	name = "The Lookout"
